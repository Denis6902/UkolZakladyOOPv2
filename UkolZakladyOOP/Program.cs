...
namespace UkolZakladyOOP
{
    class Program
    {
        static public void Main(string[] args)
        {
            ...
            Subject English1_1 = new("English1_1", Pavel, Pavel, 50, 1, Semester.Summer, subjects, 1);
            Subject Czech1_1 = new("Czech1_1", Aneta, Aneta, 50, 1, Semester.Summer, subjects, 1);

            Subject English2_1 = new("English2_1", Pavel, Pavel, 50, 2, Semester.Summer, subjects, 1);
            Subject Czech2_1 = new("Czech2_1", Aneta, Aneta, 50, 2, Semester.Winter, subjects, 1);

            Subject English3_1 = new("English3_1", Pavel, Pavel, 50, 3, Semester.Summer, subjects, 1);
            Subject Czech3_1 = new("Czech3_1", Aneta, Aneta, 50, 3, Semester.Winter, subjects, 1);

            Subject English1_2 = new("English1_2", Pavel, Pavel, 50, 1, Semester.Summer, subjects, 2);
            Subject Czech1_2 = new("Czech1_2", Aneta, Aneta, 50, 1, Semester.Summer, subjects, 2);

            Subject English2_2 = new("English2_2", Pavel, Pavel, 50, 2, Semester.Summer, subjects, 2);
            Subject Czech2_2 = new("Czech2_2", Aneta, Aneta, 50, 2, Semester.Winter, subjects, 2);

            Subject English3_2 = new("English3_2", Pavel, Pavel, 50, 3, Semester.Summer, subjects, 2);
            Subject Czech3_2 = new("Czech3_2", Aneta, Aneta, 50, 3, Semester.Winter, subjects, 2);

            Subject x = new("x", Pavel, null, 0, 1, Semester.Summer, subjects, 1); // TEST_ONLY
            Lecture c = new("c", false, 0, x, lectures, Pavel); // TEST_ONLY
            Exercise o = new Exercise("o", false, 0, x, exercises);

            Pavel.subjects = subjects.ToList();
            Aneta.subjects = subjects.ToList();

            Student Jakub = new(1, "Jakub", "Novák", new DateTime(1999, 7, 2), new DateTime(2020, 10, 1),
                subjects.ToList(), exercises, 1);
            ...
            Method Method = new();
            Method.mainMenu(chosenExercise, chosenStudent, chosenTeacher, chosenSubject, teachers, whoIAm,
                chosenLecture, exercises, subjects, lectures, currentSemester, delay);
        }
    }
}